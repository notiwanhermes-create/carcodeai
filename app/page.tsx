    ...
    <main className={cn(
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-6 sm:py-10">
        ...
        {!authUser && !authLoading && (
          <div className={cn("mt-4 rounded-2xl px-4 py-3 flex items-center gap-3", t("bg-amber-500/10 border border-amber-500/20", "bg-amber-50 border border-amber-200"))}>
        ...
        {showInstallBanner && installPrompt && (
          <div className={cn("mt-4 rounded-2xl px-4 py-3 flex items-center gap-3", t("bg-blue-500/10 border border-blue-500/20", "bg-blue-50 border border-blue-200"))}>
